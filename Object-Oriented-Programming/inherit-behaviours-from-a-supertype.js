...
Dog.prototype = Object.create(Animal.prototype);// set the prototype of the subtype (or child)—in this case, Dog—to be an instance of Animal.


let beagle = new Dog("Shoyo");
console.log(beagle); // { name: 'Shoyo' }
